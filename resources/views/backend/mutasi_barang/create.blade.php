              ...
              <div class="card">
                  ...
                  <div class="card-body">
                      <div class="basic-elements">
                          <form action="{{ route('mutasi-barang.store') }}" enctype="multipart/form-data" method="post">
                            @csrf
                              <div class="row">
                                  <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Kode Barang<span style="color:red;"> *</span></label>
                                        <input type="number" min="0" name="kode_barang" class="form-control" value="{{ old('kode_barang') }}">
                                      ...
                                      <div class="form-group dropzone">
                                          <input class="form-control" name="featured_image" type="file" value="{{ old('featured_image') }}" multiple/>
                                      </div>
                                      <p style="color:red;font-size:13px;">
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label>Dari<span style="color:red;"> *</span></label>
                                        <input type="text" name="dari" class="form-control" value="{{ old('dari') }}">
                                        <p style="color:red;font-size:13px;">
                                          @if($errors->has('dari'))
                                          <i class="fa fa-exclamation-circle"></i> {{$errors->first('dari')}}
                                          @endif
                                        </p>
                                    </div>
                                    <div class="form-group">
