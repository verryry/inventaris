                              ...
                              <tbody>
                                @foreach($barang as $barangs)
                                  <tr>
                                    ...
                                    <td>{{ $barangs->stok }}</td>
                                      <td>
                                        <a href="{{ route('barang.edit', $barangs->id) }}" class="btn btn-link px-0" name="button"> Edit </a>
                                        <button class="btn btn-link px-0" form="{{ $barangs->id }}" type="submit" name="button">Hapus </button>
                                        <form action="{{ route('barang.destroy',$barangs->id) }}" id="{{ $barangs->id }}" method="POST" style="display:none !important;">
